...
5. 资料填写提示或提审准备度检查按 [review risk checklist](review-risk-checklist.md) 将官方规则、当前事实、历史审核、测试证据和 Agent 判断分层。官方规则只从 [`official-review-rules-v4.md`](../../official-review-rules-v4.md) 选择与当前字段直接相关的章节。
